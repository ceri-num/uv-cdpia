...
{% hint style="info" %}
Tout cela forme l'alphabet de notre modèle de premier ordre.
{% endhint %}
...
Soit $$n_P$$ un poids associé à chaque prédicat $$P \in \mathcal{P}$$. $$P(x_1,x_2\dots x_n)$$ est une formule ou un mot *ssi* $$P$$ est de poids $$n.
